...
export class Convert {
    public static toWelcome(json: string): PokemonSpecie {
        return cast(JSON.parse(json), r("PokemonSpecie"));
    }

    public static welcomeToJson(value: PokemonSpecie): string {
        return JSON.stringify(uncast(value, r("PokemonSpecie")), null, 2);
    }
}
